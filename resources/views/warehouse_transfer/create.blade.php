                                    ...
                                    <form action="{{ route('warehouse-transfer.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s4">
                                                ...
                                                <label for="remarks" class="ls">Transfer Number</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                             ...
                                             <div class="col-12 col-md-4">
    <label for="warehouse_id">From Warehouse</label>
    <select class="form-control" id="warehouse_id2" name="warehouse_id2" required>
        <option value="" disabled selected>Select Warehouse</option>
        @foreach ($warehouses as $warehouse)
            <option value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
        @endforeach
    ...
    <div class="item">
        <div class="row product-item" style="border: 2px solid #ccc; padding: 10px; border-radius: 5px; margin-bottom: 10px;">
            ...
            <div class="col-12 col-md-2">
                    <label>Brand</label>
                    <select class="form-control brand" name="items[0][brand]">
            ...
            <div class="input-field col s3">
              <input type="text" class="validate code" name="items[0][code]">
...
<script>
    $(document).ready(function() {
        ...
        // Trigger filter when warehouse changes (global)
        $('#warehouse_id').on('change', function () {
            // You can either reload products OR trigger `.change()` on brand/code to fetch again
                ...
                success: function (response) {
                    ...
                    $.each(response, function (index, product) {
                        productSelect.append(
                            ...
                            product.name + ' (' + product.stock + ') (' + product.category_name + ')' +
                            '</option>'
                        );
                    });

                    productSelect.prop('selectedIndex', 0).trigger('change');
                },
                error: function () {
