                                                    ...
                                                    <div class="tab-inn">
                                                        <div class="table-responsive table-desi">
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tfoot>
                                                                    @php
    $totalAmount = $invoice->invoiceProducts->sum(fn($ip) => $ip->quantity * $ip->price);
    $discountAmount = $totalAmount * ($invoice->discount / 100);
    $grandTotal = $totalAmount - $discountAmount;
@endphp

<tr>
    <td colspan="5" class="text-end"><strong>Grand Total (Before Discount):</strong></td>
    <td>{{ number_format($totalAmount, 2) }}</td>
</tr>
<tr>
    <td colspan="5" class="text-end"><strong>Discount ({{ $invoice->discount }}%):</strong></td>
    <td>- {{ number_format($discountAmount, 2) }}</td>
</tr>
<tr>
    <td colspan="5" class="text-end"><strong>Grand Total (After Discount):</strong></td>
